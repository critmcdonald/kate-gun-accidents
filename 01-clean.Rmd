...
Adding blank columns for tx, zip and county. Sets city as value of city_or_county, which is cleaned in the next step. We add an id so we can export parts and merge the back to the correct records.
